...
import { checkId, getUserById, getUserByKey, getUserByUserId, loginApi, logoutApi, postUser } from "./usersApi";
...
export const logout=createAsyncThunk(LOGOUT, async(payloac, thunkAPI)=> {
